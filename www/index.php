    ...
    <body>
        <div class="container-fluid">
            <div class="row">
                ...
                <?php if (!isset($_GET['ccr'])) echo
                "<div class='offset-lg-2 col-lg-8 text-center'>
                    <h2 class='my-5'>" . $translations[$lang]['networks'] . "</h2>
                    <div class='col-lg-3 mb-xs-1 d-inline-block'>
                        <a href='https://twitter.com/Paragoumba' target='_blank'>
                            <div class='card bg-dark'>
                                ...
                                <div class='card-body'>
                                    <p class='card-text'>" . $translations[$lang]['twitter-account'] . "</p>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class='col-lg-3 d-inline-block'>
                        <a href='https://github.com/Paragoumba' target='_blank'>
                            <div class='card bg-dark'>
                                ...
                                <div class='card-body'>
                                    <p class='card-text'>" . $translations[$lang]['github-account'] . "</p>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class='col-lg-3 d-inline-block'>
                        <a href='mailto:paragoumba@gmail.com' target='_blank'>
                            <div class='card bg-dark'>
                                ...
                                <div class='card-body'>
                                    <p class='card-text'>" . $translations[$lang]['mail-address'] . "</p>
                                </div>
                            </div>
                        </a>
                    </div>
                    <hr class='my-5'>
                    <h2 class='my-5'>" . $translations[$lang]['language'] . 's' . "</h2>
                    <div>
                        <div class='col-lg-3 d-inline-block'>
                            <div class='card bg-dark'>
                                <div class='card-header'>
                    ...
                    <hr class='my-5'>
                    <h2 class='my-5'>" . $translations[$lang]['projects'] . "</h2>
                    <div class='col-lg-5 mb-4 d-inline-block'>
                        <a href='https://github.com/Paragoumba/paragoumba.fr' target='_blank'>
                            <div class='card bg-dark'>
                                ...
                                <div class='card-body'>
                                    <p class='card-text'>" . $translations[$lang]['desc-paragoumba.fr'] . "</p>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class='col-lg-5 mb-4 d-inline-block'>
                        <a href='https://github.com/Paragoumba/ProjectTest' target='_blank'>
                            <div class='card bg-dark'>
                                ...
                                <div class='card-body'>
                                    <p class='card-text'>" . $translations[$lang]['desc-projecttest'] . "</p>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class='col-lg-5 d-inline-block'>
                        <a href='https://dev.paragoumba.fr' target='_blank'>
                            <div class='card bg-dark'>
                                <div class='card-header'>" . $translations[$lang]['desc-other-projects'] . "</div>
                                <div class='card-body'>
                                    <p class='card-text'>" . $translations[$lang]['desc-devsite'] . "</p>
                                </div>
                            </div>
                        </a>
                    </div>
                ...
                "<h1 class='col-lg-12 mt-15 text-center'>Cert renew in</h1>
                <h2 id='countdown' class='col-lg-12 mb-15 text-center'></h2>"?>
        ...
        <?php if (isset($_GET['ccr'])) echo "<script src='countdown.js'></script>"?>
    </body>
</html>
